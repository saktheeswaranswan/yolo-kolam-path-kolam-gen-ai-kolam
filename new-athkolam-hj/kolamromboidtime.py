...
axiom = "FBFBFBFB"
iterations = 2
forward_len = 3.5  # Scaled to fit rhombus in 10x10
curve_colors = ["red", "blue", "green"]
curve_index = 0
movement_log = []

current_time_ms = 0  # Starts at 0
time_step_ms = 50    # Millisecond increment per step
...
turtle.title("Rhombus Kolam via L-System")
turtle.bgcolor("white")
turtle.speed("fastest")
turtle.pensize(2)

# Center and rotate drawing to 45 degrees
turtle.penup()
turtle.setpos(0, 0)
turtle.setheading(45)  # Rotate square into rhombus
turtle.pendown()
